...
class __TwigTemplate_ac7d5f3289ce054c75fe259863dd924c extends Template
{
        ...
        ";
            ...
            <td class=\"text-center\">";
                ...
                if (CoreExtension::getAttribute($this->env, $this->source, $context["product"], "thumb", [], "any", false, false, false, 29)) {
                    ...
                    yield "\" title=\"";
                    yield CoreExtension::getAttribute($this->env, $this->source, $context["product"], "name", [], "any", false, false, false, 29);
                    yield "\" class=\"img-thumbnail\" style=\"width: 100px\"/></a>";
                }
                yield "</td>
    ...
    <table class=\"table table-bordered\">
      ...
      <tbody>
        {% for product in products %}
          <tr>
            <td class=\"text-center\">{% if product.thumb %}<a href=\"{{ product.href }}\"><img src=\"{{ product.thumb }}\" alt=\"{{ product.name }}\" title=\"{{ product.name }}\" class=\"img-thumbnail\" style=\"width: 100px\"/></a>{% endif %}</td>
...
{% endif %}
", "catalog/view/template/checkout/cart_list.twig", "/var/www/opencart/catalog/view/template/checkout/cart_list.twig");
    }
}
