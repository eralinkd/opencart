...
\t\t\t</div>
\t</header>
\t<main class=\"app-main {% if is_main_page %}is-main-page{% endif %}\">", "catalog/view/template/common/header.twig", "/var/www/opencart/catalog/view/template/common/header.twig");
    }
}
