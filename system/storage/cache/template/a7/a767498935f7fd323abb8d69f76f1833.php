  ...
  <div class=\"container-fluid\">
    <div class=\"row\">
      <div id=\"filter-category\" class=\"col-lg-3 col-md-12 order-lg-last d-none d-lg-block mb-3\">
        ...
        yield "\" placeholder=\"Enter category name to search...\" id=\"input-name\" data-oc-target=\"autocomplete-name\" class=\"form-control\" autocomplete=\"off\"/>
                <div class=\"form-text\">Type category name to filter the list</div>
        ...
        yield " - Show only enabled categories</option>
                  <option value=\"0\"";
        // line 43
        ...
        yield " - Show only disabled categories</option>
                </select>
                <div class=\"form-text\">Filter categories by their status (enabled/disabled)</div>
              </div>
              <div class=\"text-end\">
...
";
    ...
    {
        return array (  291 => 155,  266 => 133,  259 => 129,  250 => 123,  245 => 121,  218 => 97,  199 => 81,  177 => 62,  173 => 61,  160 => 51,  155 => 49,  142 => 43,  134 => 42,  126 => 37,  117 => 31,  111 => 28,  103 => 23,  94 => 16,  83 => 14,  79 => 13,  74 => 11,  65 => 9,  59 => 8,  55 => 7,  51 => 6,  42 => 1,);
    }
          ...
          <div class=\"card-body\">
            <form id=\"form-filter\">
              <div class=\"mb-3\">
                ...
                <input type=\"text\" name=\"filter_name\" value=\"{{ filter_name }}\" placeholder=\"Enter category name to search...\" id=\"input-name\" data-oc-target=\"autocomplete-name\" class=\"form-control\" autocomplete=\"off\"/>
                <div class=\"form-text\">Type category name to filter the list</div>
                <ul id=\"autocomplete-name\" class=\"dropdown-menu\"></ul>
              </div>
              <div class=\"mb-3\">
                ...
                <select name=\"filter_status\" id=\"input-status\" class=\"form-select\">
                  <option value=\"\">All Statuses</option>
                  <option value=\"1\"{% if filter_status == '1' %} selected{% endif %}>{{ text_enabled }} - Show only enabled categories</option>
                  <option value=\"0\"{% if filter_status == '0' %} selected{% endif %}>{{ text_disabled }} - Show only disabled categories</option>
                </select>
                <div class=\"form-text\">Filter categories by their status (enabled/disabled)</div>
              </div>
              <div class=\"text-end\">
...
//--></script>
{{ footer }}
", "admin/view/template/catalog/category.twig", "D:\\xampp\\htdocs\\opencart\\admin\\view\\template\\catalog\\category.twig");
    }
}
