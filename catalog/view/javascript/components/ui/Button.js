if (!customElements.get('ui-button')) {
  class UIButton extends HTMLElement {
    constructor() {
      ...
      const template = document.getElementById('ui-button-template');
      if (!template) {
        console.error('Template "ui-button-template" not found');
        return;
      }
      ...
      this.button = shadowRoot.querySelector('.ui-button');
    }
